...
uint32_t 
lower_bound(const uint32_t * addr, uint32_t size, const uint32_t val)
{
    uint32_t mid = 0;
...
uint32_t
upper_bound(const uint32_t * addr, uint32_t size, const uint32_t val)
{
    uint32_t mid = 0;
    uint32_t off_from_begin = 0;
...
void
_test_search_framework(
    const uint32_t * b_dst, uint32_t size
