...
int main()
{
    ...
    test_framework(only_wait, only_signal, "only-wait--only-signal_bad"); fprintf(stdout, "\n\n");
    test_framework(only_wait, mutex_signal, "only-wait--mutex-sigal_bad");  fprintf(stdout, "\n\n");
    test_framework(if_wait, signal_after_variable, "if-wait--signal-after-variable_bad");  fprintf(stdout, "\n\n");
    test_framework(while_wait, signal_after_variable, "while-wait--signal-after-variable_ok");  fprintf(stdout, "\n\n");
    test_framework(while_wait, signal_after_v2_variable, "while-wait--signal-nomutex-after-variable_ok");  fprintf(stdout, "\n\n");
    test_framework(while_wait, signal_before_variable, "while-wait--signal-before-variable_ok"); fprintf(stdout, "\n\n");
    test_framework(while_wait, signal_before_v2_variable, "while-wait--signal-before-v2-variable_bad"); fprintf(stdout, "\n\n");
