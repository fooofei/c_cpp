...
int main()
{
    ...
    test_framework(while_wait, signal_before_variable, "wait--signal-before-variable_ok");
    fprintf(stdout, "\n\n");
    test_framework(while_wait, signal_after_variable, "wait--signal-after-variable_ok");
    fprintf(stdout, "\n\n");
